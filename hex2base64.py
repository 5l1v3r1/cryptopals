...
#conversion of each character from hexadecimal to binary (4 bit)
def hex2bin(hexd):
    binary = ''
    for element in hexd:
...
#6 bit binary to decimal to mapping
def bin2map(b):
    dec = int(str(b),2)
    return mapping[dec]
...
if __name__ == "__main__":
    ...
    #padding of 0's if remainder is there
    if remainder == 4:
        #pad 1 byte of 0's
        padding = 1
        hexd += "00"
...
#Decoded base64 = {I'm killing your brain like a poisonous mushroom}
